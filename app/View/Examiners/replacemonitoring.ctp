<div class="modalarea">
<h2><?php echo __('Monitoring') . ' - ' . $certificate_data_old_infos['ExaminerMonitoring']['certificat'];?></h2>
...
<?php
echo $this->element('js/examiner_put_zert_date',array('DateID' => 'ExaminerMonitoringDataCertifiedDate'));
echo $this->element('js/form_send_modal',array('FormId' => 'ExaminerMonitoringDataReplacemonitoringForm'));
