<div class="modalarea">
<h2><?php echo __('Examiner') . ' ' . $certificate_data['Examiner']['name'] . ' ' . __('add certificate');?></h2>
...
?>
<?php echo $this->Form->create('Certificate', array('class' => 'login','autocomplete' => 'off')); ?>
<fieldset>
<?php
...
<div class="clear"></div>
<?php
echo $this->element('js/form_send_modal',array('FormId' => 'CertificateQualificationnewForm'));
echo $this->element('js/form_certifcate_active_deactive');
