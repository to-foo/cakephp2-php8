<div class="modalarea">
<h2><?php echo __('Examiner') . ' ' . $eyecheck_data['Examiner']['name'] . ' ' . __('eye check');?></h2>
<?php echo $this->element('Flash/_messages');?>
<div id="container_summary" class="container_summary" ></div>
<div class="current_content">
<?php
return;
echo $this->Form->create('Eyecheck', array('class' => 'dialogform')); ?>
<fieldset>
<?php
...
<?php
echo $this->Html->link($modus_disc, array_merge(array('action' => 'eyecheck'), $this->request->projectvars['VarsArray']), array('rel' => $modus,'class' => 'round refreshexaminer'));
?>
...
echo '</strong><br />';
echo $eyecheck_data['EyecheckData']['remark'];
echo '</p>';
echo '</div>';
...
$(document).ready(function(){
	...
	$("a.refreshexaminer").click(function() {
