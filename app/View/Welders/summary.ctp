		...
		foreach($_summary as $__key => $__summary){
			if(count($__summary)> 0){
				foreach($__summary as $___key => $___summary){
					...
					$this->request->projectvars['VarsArray'][15] = $___summary['welder']['id'];
					...
					$output_messages[$_key] .= __('Welder',true). ': ' . $___summary['welder']['name'].' ';
...
//					$output_messages[$_key] .= $this->Html->link(__('Edit Welder',true),array_merge(array('action' => 'edit'),$this->request->projectvars['VarsArray']),array('title' =>__('Edit Welder',true),'class' => 'mymodal_live icon icon_welder'));
...
//					$output_messages[$_key] .= $this->Html->link(__('Edit Welder',true),array_merge(array('action' => 'edit'),$this->request->projectvars['VarsArray']),array('class' => 'mymodal_live  icon icon_welder'));
					$output_messages[$_key] .= '<div class="clear"></div>';
					$output_messages[$_key] .= '</li>';
					$output_messages[$_key] .= '</ul>';
					$output_messages[$_key] .= '</li>';
