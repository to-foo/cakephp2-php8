...
//echo $this->Html->link(__('Show file'),array_merge(array('action' => 'getcertificatefiles'),$this->request->projectvars['VarsArray']),array('class' => 'round','target'=>'_blank'));
//echo $this->Html->link(__('Delete file'),array_merge(array('action' => 'delcertificatefiles'),$this->request->projectvars['VarsArray']),array('class' => 'round mymodal'));
