...
<h2><?php echo __('Add a step to'); ?> <?php echo $this->request->data['HeadLine'];?></h2>
...
if(count($this->request->data['UnusedExpeditingTypes']) == 0){
...
<fieldset>
<?php
echo $this->Form->input('expediting_type_id',array('options' => $this->request->data['UnusedExpeditingTypes']));
...
echo $this->element('js/form_send_modal',array('FormId' => 'ExpeditingSetsExpeditingTypeAddeventForm'));
?>
</div>