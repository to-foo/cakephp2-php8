...
<h2><?php echo __('Delete files'); ?></h2>
...
echo $this->Form->input('files',array('type' => 'hidden'));
?>
</fieldset>
...
echo $this->element('js/form_send_modal',array('FormId' => 'ExpeditingDelmanyfilesForm'));
?>
