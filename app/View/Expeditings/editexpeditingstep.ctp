...
<h2>
<?php echo __('Edit Expediting Step'); ?> 
</h2>
...
echo $this->Form->input('hold_witness_point', array('options' => array(0 => '-',1 => __('Witness'),2 => __('Hold')),'type' => 'radio'));
...
echo $this->Form->input('Roll',array(
	...
	'options' => $Rolls,
	'selected' => $this->request->data['Roll']
						)
					);
?>
</fieldset>
...
echo $this->element('js/form_send_modal',array('FormId' => 'ExpeditingSetsExpeditingTypeEditexpeditingstepForm'));
?>
