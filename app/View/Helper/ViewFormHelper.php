...
class ViewFormHelper extends AppHelper
{
  ...
  public function CreateMasterDropdownEditLink($LinkAfter, $data, $_setting, $setting, $disabled, $x)
  {
    ...
    $output =
      $this->Html->link(__('Edit'), array_merge(
        array(
  ...
  public function CreateTemplateEditFieldLink($data, $_setting, $setting, $disabled, $x)
  {
    ...
    $attention_class = 'icon_attention_unmarked';

    if (isset($data['Attention'][$Model][$field]))
      $attention_class = 'icon_attention_marked';
    ...
    $output .= $this->Html->link(
      ...
      array(
        ...
        'rel'   => $field,
        'rev'   => $Model,
        'class' => 'icon icon_template_field_delete delete_template_field'
      )
    );
    ...
    $output .= $this->Html->link(
      ...
      array(
        'title' => __('Attention', true),
        'rel'   => $field,
        'rev'   => $Model,
        'class' => 'icon attention_template_field icon_attention ' . $attention_class
      )
    );
  ...
  public function CreateRadioForReport($data, $_setting, $setting, $attribut_array, $hidable, $disabled, $x)
  {
    ...
    if ($this->request->params['controller'] == 'templates') {
      $attribut_array['after'] = $this->CreateTemplateEditFieldLink($data, $_setting, $setting, $disabled, $x);
    }
  ...
  public function CreateRadioForReportTemplate($data, $_setting, $setting, $attribut_array, $hidable, $disabled, $x)
  {
    ...
    if (isset($attribut_array['attention'])) {
      $attribut_array['before'] = '<div class="input radio attention_field">';
      $attribut_array['after']  = '</div>';
    }
    ...
    if (isset($attribut_array['attention']))
      $attribut_array['class'] .= ' ' . $attribut_array['attention'];
  ...
  public function CreateInputForReport($data, $_setting, $setting, $attribut_array, $hidable, $disabled, $x)
  {
    ...
    if (!empty($_setting->format) && trim($_setting->format) == 'date')
      return null;
    if (!empty($_setting->format) && trim($_setting->format) == 'datetime')
      return null;
  ...
  public function CreateMultiselectForReport($data, $_setting, $setting, $attribut_array, $hidable, $disabled, $x, $hideBox)
  {
    ...
    if ($this->request->params['controller'] == 'templates') {
      ...
      $SelectOptions['after'] = $this->CreateTemplateEditFieldLink($data, $_setting, $setting, $disabled, $x);
    }
  ...
  public function CreateDropdownForReport($data, $_setting, $setting, $attribut_array, $hidable, $disabled, $x)
  {
    ...
    $LinkAfter = $this->CreateMasterDropdownEditLink($LinkAfter, $data, $_setting, $setting, $disabled, $x);
    $LinkAfter = $this->CheckForCertifcateManager($LinkAfter,$_setting);
    ...
    if (isset($attribut_array['attention']))
      $SelectOptions['class'] .= ' ' . $attribut_array['attention'];
  ...
  public function CheckForCertifcateManager($link,$data){

    if(Configure::check('CertifcateManagerReportInsert') === false) return $link;
		if(Configure::read('CertifcateManagerReportInsert') == false) return $link;

    $blacklist = array('examiner','supervision');
    $field = trim($data->key);
