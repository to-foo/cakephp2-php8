...
$nbrbar = 6;
$cellwidth = 50;
$tableypos = $tableymultipli * $x_text;
$tablexpos = 10;
...
$graph->ClearTheme();
$graph->img->SetMargin(50,20,$Enypos,40);
