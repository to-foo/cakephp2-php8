<div class="inhalt">
<h2><?php echo __('Dropdown Manager', true); ?></h2>
<div class="quicksearch">
<?php
echo $this->Html->link(__('Add Testing Instruction', true), array_merge(array('action' => 'masteradd'), array()), array('class' => 'modal icon icon_examiners_add', 'title' => __('Add dropdown field', true)));
...
//            pr($__data['DropdownsMaster']['field']);
            ...
            echo ' <span>(' . $__data['DropdownsMaster']['field'] . ')</span>';
