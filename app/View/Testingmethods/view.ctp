...
<div class="inhalt">
<div class="testingmethods view">
<h2><?php  echo __('Testingmethod'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($testingmethod['Testingmethod']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Value'); ?></dt>
		<dd>
			<?php echo h($testingmethod['Testingmethod']['value']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($testingmethod['Testingmethod']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Testing method'); ?></dt>
		<dd>
			<?php echo h($testingmethod['Testingmethod']['verfahren']); ?>
			&nbsp;
		</dd>
	</dl>
	<div class="clear edit">
		...
		echo $this->Html->link(__('Edit this testingmethod', true), array('action' => 'edit', $testingmethod['Testingmethod']['id'])); 
		echo $this->Html->link(__('New testingcomp'), array('controller' => 'testingcomps', 'action' => 'add'));
		echo $this->Html->link(__('New testingmethod'), array('controller' => 'testingmethods', 'action' => 'add'));
...
<div class="related">
	...
	<?php if (!empty($testingmethod['Qualification'])): ?>
	...
	<tr>
		...
		<?php
		$i = 0;
		foreach ($testingmethod['Qualification'] as $qualification):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}		
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $testingmethod['Testingmethod']['name']; ?></td>
...
<div class="related">
	...
	<?php if (!empty($testingmethod['Topproject'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		...
		<?php
		$i = 0;
		foreach ($testingmethod['Topproject'] as $topproject):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}		
