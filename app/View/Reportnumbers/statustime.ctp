...
<?php echo $this->Form->create('Reportnumber', array('class' => 'dialogform')); ?>
	<fieldset>
		<legend><?php echo __('What do you want to do ?', true); ?></legend>
	<?php
	...
	<legend class="links">
    	<?php
		echo $this->Html->Link($supervisor_text,array('action' => 'status2'),array('id' => 'ReportnumberSupervisorTrue'));
		echo $this->Html->Link(__('revoke examiner release'),array('action' => 'status2'),array('id' => 'ReportnumberExaminerTrue'));
		?>
<!--        
