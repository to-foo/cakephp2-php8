...
<dl id="status_ws"><span>Not connected</span> <input class="button" id="SignBtn" name="SignBtn" type="button" value="open sign pad" onclick="getSignature();" /></dl>
<dl id="Status_pad_0"><span>Sign pad not conected</span></dl>
<dl id="PadType_0">Pad Type: <span></span></dl>
<dl id="SerialNumber_0">Serial Number: <span></span></dl>
<dl id="FirmwareVersion_0">Firmware Version: <span></span></dl>
<ul id="log"></ul>
</div>
...
//                state.innerHTML = "Connected to server " + wsUri;
 				$(state + " span").text("Connected to WSS service ");
...
//                            alert("The search for pads failed. Reason: " + obj.TOKEN_PARAM_ERROR_DESCRIPTION);
							$("#Status_pad_0 span").html(obj.TOKEN_PARAM_ERROR_DESCRIPTION + " <?php echo __('The current connection has been closed, please try again',true);?>");
...
//                            alert("No connected pads have been found.");
							$("#Status_pad_0 span").html("<?php echo __('No connected pads have been found.');?>");
							$("#Status_pad_0").removeClass("success");
							$("#Status_pad_0").addClass("fail");
                            searchState = searchStates.setPadType;
                            openState = openStates.openPad;
