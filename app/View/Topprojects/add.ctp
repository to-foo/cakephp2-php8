<div class="modalarea">
<!-- Beginn Headline -->
<h2><?php echo __('Add topproject'); ?></h2>
<!-- Ende Headline -->
<!-- Beginn Message -->
...
echo $this->Form->input('add_master_dropdowns', array(
    'options' => array('1' => __('Add master dropdown values'), '0' => __('Dont add master dropdown values')),
	'value' => 1,
    'type' => 'radio',
));
...
echo $this->Form->input('Report',array('multiple' => true,'label' => __('Involved reports',true)));
echo '</fieldset>';
echo '<fieldset class="multiple_field">';
...
echo $this->element('js/form_send_modal',array('FormId' => 'TopprojectAddForm'));
?>
