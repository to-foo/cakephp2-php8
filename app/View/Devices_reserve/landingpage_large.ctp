<h3><?php echo __('Devices',true); ?></h3>
<div class="quicksearch">
<?php // echo $this->element('barcode_scanner');?>
<?php
echo $this->Html->link(__('Open devices modul',true),
	array(
		'controller' => 'devices',
		'action' => 'index'
	),
	array(
		'class' => 'round ajax',
		'title' => __('Open devices modul',true)
	)
);
...
echo $this->Html->link(__('Add device',true),
	...
	array('class' => 'modal icon icon_devices_add','title' => __('Add device',true)));
