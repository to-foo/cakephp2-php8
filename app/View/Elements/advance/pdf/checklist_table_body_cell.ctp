<?php
	...
	$tcpdf->MultiCell(
		$CellW,
		5,
		implode(',',$tcpdf->Advance['Scheme']['CollectMesurePoints'][$key]['open']),
		0,
		'L',
		0,
		1,
	...
	$tcpdf->MultiCell(
		$CellW,
		5,
		implode(',',$tcpdf->Advance['Scheme']['CollectMesurePoints'][$key]['close']),
		0,
		'L',
		0,
		1,
...
/*
	$tcpdf->MultiCell(
		$CellW,
		5,
		implode(',',$tcpdf->Advance['Scheme']['CollectMesurePoints'][$key]['repair']),
		0,
		'L',
		0,
		1,
