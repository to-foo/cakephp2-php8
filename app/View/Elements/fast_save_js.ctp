...
<?php
$url = $this->Html->url(array('controller'=>'reportnumbers','action'=>'save',
	implode('/',$this->request->projectvars['VarsArray'])
	)
);
?>
...
$(document).ready(function(){
	...
	$("form.editreport input, form.editreport select, form.editreport textarea").each(function(){
