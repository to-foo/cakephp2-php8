...
if(isset($this->request->data['StatusMessages']['Priority'][$_examiner['Supplier']['priority']])) $status_icon = $this->request->data['StatusMessages']['Priority'][$_examiner['Supplier']['priority']];
...
if(isset($this->request->data['ExpeditingLinks']['overview'])){
		echo $this->Html->link($_examiner['Supplier']['unit'] . '-' . $_examiner['Supplier']['equipment'],
		array_merge(array('action' => 'overview'),$this->request->projectvars['VarsArray']),
		array('title' => __('Expediting info',true),'class'=>'icon_larger icon_info modal '.$status_icon . '_overview')
	);
}
if(isset($this->request->data['ExpeditingLinks']['files'])){
...
if(isset($this->request->data['ExpeditingLinks']['images'])){
...
if(isset($this->request->data['ExpeditingLinks']['detail'])){
	echo $this->Html->link($_examiner['Supplier']['unit'] . '-' . $_examiner['Supplier']['equipment'],
...
if(isset($this->request->data['ExpeditingLinks']['control'])){
