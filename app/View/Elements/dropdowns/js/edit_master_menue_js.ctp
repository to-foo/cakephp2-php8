...
if(empty($this->request->data['DropdownsMaster']['field']) == true) {
	echo $this->Form->input('CurrentArea',array('value' => 'main_area','type' => 'hidden'));
	echo $this->Form->input('CurrentAreaLink',array('value' => 'link_main_area','type' => 'hidden'));
} else {
	echo $this->Form->input('CurrentArea',array('value' => 'data_area','type' => 'hidden'));
	echo $this->Form->input('CurrentAreaLink',array('value' => 'link_data_area','type' => 'hidden'));
}
...
$(document).ready(function() {
	...
	current_area = $("#CurrentArea").val();
	current_area_link = $("#CurrentAreaLink").val();
