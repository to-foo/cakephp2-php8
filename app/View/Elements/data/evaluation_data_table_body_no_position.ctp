...
foreach ($this->request->data['Welds'] as $dataArray) {
  ...
  echo $this->element('data/evaluation_data_table_body_data_no_position',array('dataArray' => $dataArray,'evalDiscription'  => $evalDiscription,'revtrue' => $revtrue,'comp_weld' => $comp_weld));
