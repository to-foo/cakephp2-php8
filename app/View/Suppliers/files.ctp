<div class="modalarea">
<h2><?php echo __('Fileupload', true);?> <?php echo $Supplier['Supplier']['equipment'];?></h2>
...
echo $this->element('expediting/js/form_upload_report_reload_container',array('container' => '#dialog','url' => $url,'FileLabel' => __('Drop files her to upload', true),'Extension' => 'pdf|PDF'));
