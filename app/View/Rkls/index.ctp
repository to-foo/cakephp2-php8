...
<fieldset>
<?php
	foreach($SearchFieldsStandard->Rkl->children() as $_key => $_fields){
...
<?php
$autourl = $this->Html->url(array_merge(array('controller' => 'rkls','action' => 'autofast'),$this->request->projectvars['VarsArray']));
...
echo $this->element('landingpage/js/fastsearch',array('SearchFormName' => '#GenerallyIndexForm'));
?>
