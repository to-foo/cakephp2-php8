...
// zweite Überschrift z.B. englisch
        ...
        if(file_exists($this->xdata['Testingcomp']['logo']) && $this->xdata['Testingcomp']['logo_suffix'] == 'png'){
      ...
      if(file_exists($this->xdata['Testingcomp']['logo']) && $this->xdata['Testingcomp']['logo_suffix'] == 'svg'){

        $this->ImageSVG(
          $this->xdata['Testingcomp']['logo'],
          $this->xsettings->$ExaminerPdf->settings->QM_LOGO_X,
          $this->xsettings->$ExaminerPdf->settings->QM_LOGO_Y,
          $this->xsettings->$ExaminerPdf->settings->QM_LOGO_WIDTH,
          $this->xsettings->$ExaminerPdf->settings->QM_LOGO_HEIGHT,
          '',
          '',
        ...
        if($this->xsettings->$ExaminerPdf->settings->QM_FIRM_ADRESS_FORMAT->SHOW_ADRESS == 1){
				...
				if(trim($this->xdata['Testingcomp'] ['telefon']) != '') $Firmenadresse  .= 'Tel. ' . trim($this->xdata['Testingcomp'] ['telefon']) . PHP_EOL;
