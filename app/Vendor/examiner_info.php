...
// $this->xdata['deviceinfo']['adress'].
		...
		if(isset($this->xdata['examinerinfo']['logo'])){
		$this->Image(
			$this->xdata['examinerinfo']['logo'],
			20, //x
			$Y_start, //y
			30, // width
			0, // height
	...
	$this->MultiCell(
		50,
		20,
		$this->xdata['examinerinfo']['adress'],
		0,
		'L',
		0,
		1,
	...
	$this->MultiCell(
		50,
		20,
		$this->xdata['examinerinfo']['contact'],
		0,
		'L',
		0,
		1,
	...
	$this->MultiCell(
		0,
		0,
		//$this->xdata['examinerinfo']['info']['Device']['device_type'] . " - " .
		$this->xdata['examinerinfo']['info']['Examiner']['first_name'].' '. $this->xdata['examinerinfo']['info']['Examiner']['name'],
